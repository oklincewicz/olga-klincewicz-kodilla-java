...
public final class ForumUser {
    ...
    public ForumUser(final int userID, final String userName, final char sex, final int yearOfBirth, final int monthOfBirth, final int  dayOfBirth , int numberOfPosts) {
        this.userID = userID;
